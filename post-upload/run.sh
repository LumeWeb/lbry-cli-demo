...
# =============================================================================
#
# This script runs the post-upload demo which:
# - Generates a 10MB random data blob
# - Uploads it using standard upload method
...
#   LOG_FILE      - Optional log file path (default: post-upload.log)
#
# =============================================================================
